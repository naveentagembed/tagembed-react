...
import ContentConversion from '../../themes/reviewCarousel/contentConversion'
...
class ReviewBoxContentPost extends PureComponent {
    ...
    render() {
        ...
        return <div
            className={`postCardContent ${(!isRating ? 'isRating' : '')} ${(wall.ThemeRule.hideContent === 1 && item.type !== 1) ? 'p0' : ''}`}>
            ...
            <div
                ...
                {/* <ContentConversion trimContent={Math.trunc(1000 / 5)} fdata={item} contentData={item.content} fullcontentData={item.content} personalization={wall.Personalization} /> */}
