...
import '../../../scss/theme/snapCard.scss';
import { onResponsiveModernCardTheme } from '../../../utils'
import { browserName } from "react-device-detect";


class SnapCardTheme extends PureComponent {
    constructor(props) {
        super(props);
        ...
        return <Fragment>
            ...
            <div id="themesPostWrapper"
                ...
                >
                    ...
                    <div className="themeSnapCard themeWrap" style={{ left: `${parseInt(adjustLeft)}px` }}>
                        <Masonry
                            id="eThemePosts"
                            className={`SnapCard theme${wall.Personalization.widgetTheme}`}
                            elementType={'div'}
                            options={{
                        ...
                        {/* To display masonry layout for posts Start */}
...
export default connect(mapStateToProps, mapDispatchToProps)(SnapCardTheme);