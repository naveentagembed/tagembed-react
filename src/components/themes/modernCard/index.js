...
import '../../../scss/theme/modernFall.scss';
import { onResponsiveModernCardTheme } from '../../../utils';
import { browserName } from "react-device-detect";

class ModernCardTheme extends PureComponent {
    constructor(props) {
        super(props);
    ...
    state = {
        //windowWidth: document.getElementById('tagembed_main').clientWidth ? document.getElementById('tagembed_main').clientWidth : window.innerWidth,
    ...
    componentDidMount() {
        ...
        if (appendData && appendData.heightEvent && appendData.heightEvent.data.fixedHeight === 0) {
            document.getElementById("themesWrapper").addEventListener("scroll", (event) => {
                ...
                if ((documentHeight + fixedHeightScrollBar.scrollTop) >= (fixedHeightScrollBar.scrollHeight - 200)) {
            ...
            <div id="themesPostWrapper" ref={this.refCallback} style={fixedHeightStyle}>
              ...
              {  /* trial purpose for optimization */ }
                ...
                <div id="themesWrapper"
                    className={`themesWrapper themeStart${wall.Personalization.widgetTheme} themeType${wall.Personalization.themeType} ${wall.UserRule.branding_lite === 1 ? `theme${wall.Personalization.widgetTheme}_poweredByMain` : null}`}
                ...
                >
                    ...
                    <div className="themeModernCard themeWrap" style={{ left: `${parseInt(adjustLeft)}px` }}>

                        <Masonry
                            id="eThemePosts"
                            className={`modernCard theme${wall.Personalization.widgetTheme}`}
                            elementType={'div'}
                            options={{
...
export default connect(mapStateToProps, mapDispatchToProps)(ModernCardTheme);	