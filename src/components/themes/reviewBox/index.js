...
import '../../../scss/theme/reviewBox.scss'
import { onResponsiveModernCardTheme } from '../../../utils';
import { browserName } from "react-device-detect";

class ReviewBoxTheme extends PureComponent {
    constructor(props) {
        super(props);
        ...
        return <Fragment>
            ...
            <div id="themesPostWrapper" ref={this.refCallback} style={fixedHeightStyle}>
                ...
                >
                    ...
                    <div className="themeReviewBox themeWrap" style={{ left: `${parseInt(adjustLeft)}px` }}>
                        <Masonry
                            id="eThemePosts"
                            className={`reviewBox theme${wall.Personalization.widgetTheme}`}
                            elementType={'div'}
                            options={{
...
export default connect(mapStateToProps, mapDispatchToProps)(ReviewBoxTheme);