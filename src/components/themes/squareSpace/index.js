...
import '../../../scss/theme/squareSpace.scss'
import { browserName } from "react-device-detect";

class SquareSpaceTheme extends PureComponent {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const { windowWidth, windowHeight, cardNumber, adjustWidth, adjustLeft } = this.state;
        var totalPostBestFit = postData.length;
        ...
        return <Fragment>
            ...
            <div id="themesPostWrapper"
                ...
                >
                    ...
                    <div className="themeSquarePhoto themeWrap" style={{ left: `${parseInt(adjustLeft)}px` }}>

                        {/* To display the posts in masonry layout Start */}
                        <Masonry
                            id="eThemePosts"
                            className={`squarePhoto theme${wall.Personalization.widgetTheme}`}
                            elementType={'div'}
                            options={{
                        ...
                        {/* To display the posts in masonry layout End */}
...
export default connect(mapStateToProps, mapDispatchToProps)(SquareSpaceTheme);