...
import SliderCarouselExtend from './slider'
import { browserName } from "react-device-detect";

class SliderCarouselTheme extends PureComponent {
    constructor(props) {
        super(props);
    ...
    /* To Update Carousel height */
    onUpdateHeight = (height) => {
        this.setState({ heightUpdate: `${height}px` })
    }
                    ...
                    <Fragment>{wall.Personalization.filterStatus === 1 ?  <WebFilters appendData={appendData} /> : null }</Fragment>
                        <div className="themeWrap">
                            ...
                            <div id="eThemePosts"
                                ...
                                <SliderCarouselExtend onUpdateHeight={this.onUpdateHeight} />
...
export default connect(mapStateToProps, mapDispatchToProps)(SliderCarouselTheme);